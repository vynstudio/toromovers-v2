...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Sí. Our crews are bilingual and we’re proud to serve Central Florida’s Latino community. You can call, text, or fill out the quote form in either language.",
  },
  {
